...
public class MySQLiteHelper extends SQLiteOpenHelper {
     ...
     */
    private static final String DATABASE_SQL_FILENAME = "bartender_database.sql";
    /**
     * Nom du fichier de la base de données.
     */
    private static final String DATABASE_NAME = "bartender_database.sqlite";
    ...
    public static MySQLiteHelper get() {
        if (instance == null) {
            return new MySQLiteHelper(Bartender.getContext());
        }
        return instance;
    }
    ...
    private void initDatabase(SQLiteDatabase db) {
        ...
        try {
            ...
            BufferedReader in = new BufferedReader(new InputStreamReader(Bartender.getContext().getAssets().open(DATABASE_SQL_FILENAME)));
