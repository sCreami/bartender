...
INSERT INTO Boisson VALUES (NULL, "Jupiler", 5.2, "La Jupiler est actuellement encore fabriquée à Jupille et est la bière la plus populaire et la plus vendue de Belgique. Il s'agit d'une bière de basse fermentation (une pils), blonde, au goût léger velouté et malté avec une fin de bouche sèche-amère. Son volume d'alcool est de 5,2°.","", "biere");
...
INSERT INTO Boisson VALUES (NULL, "Coca-Cola", 0, "Paquet de sucre liquide","Liquid sugar", "soft");
