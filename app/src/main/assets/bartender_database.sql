...
INSERT INTO Boisson VALUES (NULL, "Abbaye d'Aulne Triple Blonde", 8.0, "Bière de haute fermentation. Elle a une couleur dorée et une mousse blanche. Cette bière douce offre des saveurs houblonnées et de levure.","Tripel blond beer", "biere", "aulne_triple");
INSERT INTO Boisson VALUES (NULL, "Affligem Blond", 7.0, "Elle a une couleur blonde dorée et une mousse blanche. Elle possède un arôme de citron, de houblon et un caractère épicé. Son volume d'alcool est de 7%.","Blond beer", "biere", "affligem_blonde");
INSERT INTO Boisson VALUES (NULL, "Affligem Dubbel", 7.0, "Elle a une couleur rouge-brune et une saveur épicée et maltée. Elle est ronde en bouche et possède une légère amertume.","Double beer", "biere", "affligem_double");
INSERT INTO Boisson VALUES (NULL, "Affligem Patersvat", 7.0, "La Patersvat est seulement brassée à la fin de l'été. Elle est blonde et possède un goût puissant avec une saveur très houblonnée. Sa fin de bouche est bien parfumée.","Blond beer", "biere", "affligem_patersvat");
INSERT INTO Boisson VALUES (NULL, "Affligem Tripel", 8.5, "Elle a une couleur blonde foncée. Elle possède un arôme fruité et parfumé. Son goût est doux et peu amer. Son volume d'alcool est de 8,5%.","Tripel blond beer", "biere", "affligem_triple");
INSERT INTO Boisson VALUES (NULL, "Floreffe Blonde", 6.3, "De couleur blonde, elle est crémeuse et légèrement acide.","Blond beer", "biere", "floreffe_blonde");
INSERT INTO Boisson VALUES (NULL, "Floreffe Double", 6.3, "Elle a une couleur brune, est parfumée et a des saveurs de malt et de caramel. Elle subit une refermentation en bouteille.","Double beer", "biere", "floreffe_double");
INSERT INTO Boisson VALUES (NULL, "Floreffe Prima Melior", 8.0, "Elle est brune, possède des épices comme le coriandre, l'anis et a un goût très malté.","Primer beer", "biere", "floreffe_pm");
INSERT INTO Boisson VALUES (NULL, "Floreffe Triple", 7.5, "Une bière avec une jolie couleur blonde et un goût aigre-doux.","Tripel blond beer", "biere", "floreffe_triple");
INSERT INTO Boisson VALUES (NULL, "Grimbergen Blond", 6.7, "Bière de haute fermentation brassée. Elle a une belle couleur blonde, un goût légèrement fruité et possède un bel équilibre dans sa constitution.","Blond beer", "biere", "grimbergen_blonde");
INSERT INTO Boisson VALUES (NULL, "Grimbergen Dubbel", 6.5, "Elle a une couleur rouge-brun et un goût doux-amer.","Double beer", "biere", "grimbergen_double");
INSERT INTO Boisson VALUES (NULL, "Grimbergen Tripel", 9.0, "Elle a une couleur blonde ambrée. Elle a un goût doux, amer et généreux.","Tripel beer", "biere", "grimbergen_triple");
INSERT INTO Boisson VALUES (NULL, "Kapittel Dubbel", 7.5, "Il s'agit d'une bière de haute fermentation qui a une couleur rouge-brune. Son arôme est principalement malté et sa saveur douce et fruitée.","Double beer", "biere", "kapittel_double");
INSERT INTO Boisson VALUES (NULL, "Kapittel Pater", 6.0, "Cette bière de haute fermentation a une couleur brune avec des reflets orangés. Elle a un arôme fruité et un goût dans lequel le malt et la levure se font fort ressentir.","Pater beer", "biere", "kapittel_pater");
INSERT INTO Boisson VALUES (NULL, "Kapittel Prior", 9.0, "caramélisées. Le houblon et l'amertume ponctuent la bière.","Prior beer", "biere", "kapittel_prior");
INSERT INTO Boisson VALUES (NULL, "Leffe Blonde", 6.5, "La Leffe Blonde est une bière de couleur dorée et aux reflets ensoleillés. Elle a une saveur douce et pleine à la fois ainsi qu'un palais puissant, doux et fruité.","Blond beer", "biere", "leffe_blonde");
INSERT INTO Boisson VALUES (NULL, "Leffe Brune", 6.5, "La Leffe Brune est une bière d'un brun profond automnal au goût moelleux et plein. Sa saveur est douce, fruitée avec quelques notes de pommes. ","Brown beer", "biere", "leffe_brune");
INSERT INTO Boisson VALUES (NULL, "Leffe Radieuse", 8.2, "La Leffe Radieuse est une bière foncée avec un arôme terreux et un goût puissant aux profondes notes fruitées.","'Radieuse' beer", "biere", "leffe_radieuse");
INSERT INTO Boisson VALUES (NULL, "Leffe Triple", 8.5, "La Leffe Triple est une bière fraîche et plein d'arôme. Elle a une couleur dorée et un palais aux dominantes citronnées et vanillées.","Tripel beer", "biere", "leffe_triple");
INSERT INTO Boisson VALUES (NULL, "Maredsous Blonde", 7.5, "De couleur ambrée, la Maredsous Blonde a un arôme fruité et un arrière goût moelleux.","Blond beer", "biere", "maredsous_blonde");
INSERT INTO Boisson VALUES (NULL, "Maredsous Brune", 8.0, "Malgré sa force, cette bière brune offre une sensation de légèreté dans la bouche.","Brown beer", "biere", "maredsous_brune");
INSERT INTO Boisson VALUES (NULL, "Maredsous Triple", 10.0, "Une bière douce de couleur ambre. Elle est marquée par un bel équilibre entre les arômes de malt et d'houblon. Arrière-goût moelleux.","Triple beer", "biere", "maredsous_triple");
INSERT INTO Boisson VALUES (NULL, "Ramée Ambrée", 7.5, "Fabriquée à la brasserie Brunehaut. Il s'agit d'une bière de haute fermentation. Elle est ronde en bouche, son arôme est malté, épicé et houblonné.","Amber beer", "biere", "ramee");
...
INSERT INTO Boisson VALUES (NULL, "Sint-Bernardus Tripel", 8.0, "St Bernardus Triple: Bière de fermentation haute. Elle a une couleur dorée et une mousse crémeuse. Elle possède un arôme doux et épicé et un goût malté. Elle subit une refermentation en bouteille.","Tripel beer", "biere", "sb_triple");
...
INSERT INTO Boisson VALUES (NULL, "Tongerlo Dubbel Bruin 6", 6.5, "La Tongerlo Double Brune 6° est une bière de haute fermentation avec refermentation bouteille, a une couleur foncée brun-rouge, un arôme caramélisé et un volume d'alcool de 6,5°.","Brown beer", "biere", "tongerlo_brune");
...
INSERT INTO Boisson VALUES (NULL, "Maes Pils", 4.9, "La Maes Pils (parfois appelée Maes Pilsener) est une bière de basse fermentation, de couleur blond pâle. Elle a un goût léger avec une pointe d'amertume, une fin de bouche sèche. Enfin, signalons que la Maes Pils n'est pas pasteurisée.","Blond beer", "biere", "maes");
INSERT INTO Boisson VALUES (NULL, "Piedboeuf Brune", 1.5, "Bière de table additionnée de sucre candi.","Brown beer", "biere", "piedboeuf_brune");
...
INSERT INTO Boisson VALUES (NULL, "Orangina", 0, "L'orangina est une boisson gazeuse non alcoolisée faite à partir d'oranges et de citrons.","Like Coca but not", "soft", "orangina");
INSERT INTO Boisson VALUES (NULL, "Jus d'orange pressé", 0, "Oranges fraichement pressées pour un goût vitalisé","More sugar than coca", "soft", "jus_orange");
INSERT INTO Boisson VALUES (NULL, "Milk shake Banane", 0, "Bananes, glace vanille, lait et une touche citronée, le tout bien mixé","Banana, vanilla ice, milk and a zest of lemon mixed together", "soft", "milkshake");
INSERT INTO Boisson VALUES (NULL, "Limonade ", 0, "Citrons frais, glaçons, sucre vanillé dans une belle cruche glacée","It's just fancy lemon juice", "soft", "limonade");
INSERT INTO Boisson VALUES (NULL, "Cognac Delamain", 30, "Le cognac est une eau-de-vie fine à base de raisin, produite dans une région délimitée centrée autour de Cognac, englobant une grande partie de la Charente, la presque totalité de la Charente-Maritime, et quelques enclaves en Dordogne et dans les Deux-Sèvres. Elle doit respecter des normes et des règles de production bien précises afin de pouvoir obtenir l'appellation cognac.","When you need to forget her", "spirit", "cognac_delamain");
INSERT INTO Boisson VALUES (NULL, "Rhum blanc Havana Club", 40, "Le Rhum est une eau-de-vie originaire des Amériques, produite à partir de la canne à sucre ou de sous-produits de l'industrie sucrière. Il est consommé blanc, vieilli en fût (rhum vieux) ou épicé. Il prend alors une coloration ambrée plus ou moins foncée.","From Cubana, the mini-market down the street", "spirit", "rhum_havana");
INSERT INTO Boisson VALUES (NULL, "Whisky Aberlour 10 ans", 45, "Le Whisky est l'ensemble des eaux-de-vie fabriquées par distillation de céréales maltées ou non maltées. L'origine du whisky est aujourd'hui encore sujette à controverses entre Irlandais et Écossais, chacun y allant de sa preuve la plus ancienne.","Arh C'ptain !", "spirit", "whisky_aberlour");
INSERT INTO Boisson VALUES (NULL, "Vodka Zubrowka", 45, "La Vodka est une eau-de-vie de pomme de terre ou de céréales, mais d'autres matières premières peuvent être utilisées.","Da ! Vodka iz goud vor every oune !", "spirit", "vodka_zubrowka");
INSERT INTO Boisson VALUES (NULL, "Gin Gordon", 40, "Le gin est une boisson alcoolisée obtenue en aromatisant de l'alcool rectifié d'origine agricole avec des baies de genévrier.","This is disgusting", "spirit", "gin_gordon");
INSERT INTO Boisson VALUES (NULL, "Tequila Cazadores", 40, "La tequila est une boisson alcoolisée produite au Mexique à partir d'une plante nommée Agave tequilana.","Let's all get drunk !", "spirit", "tequila");
