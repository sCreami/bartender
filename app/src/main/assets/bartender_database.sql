...
CREATE TABLE Facture(numeroFacture INTEGER PRIMARY KEY AUTOINCREMENT,dejaPaye REAL NOT NULL,etat INTEGER NOT NULL,jetons INTEGER,numeroTable INTEGER NOT NULL,date DATETIME NOT NULL,serveur TEXT REFERENCES Serveur(identifiant));

CREATE TABLE Detail(aLivre INTEGER,dejaLivre INTEGER,numeroProduit INTEGER REFERENCES Inventaire(numeroProduit),numeroFacture INTEGER REFERENCES Facture(numeroFacture));
...
INSERT INTO Facture VALUES (NULL,  0, 1, 0, 3, 2013-10-07, (SELECT identifiant FROM Serveur WHERE nom="Denis"));
INSERT INTO Facture VALUES (NULL, 12, 1, 2, 1, 2015-02-14, (SELECT identifiant FROM Serveur WHERE nom="Denis"));
INSERT INTO Facture VALUES (NULL, 40, 0, 8, 2, 2014-01-01, (SELECT identifiant FROM Serveur WHERE nom="Marcel"));
INSERT INTO Facture VALUES (NULL, 34, 1, 6, 1, 2014-01-02, (SELECT identifiant FROM Serveur WHERE nom="Philippe"));

INSERT INTO Detail VALUES (4, 3, 1, 1); /* Facture 1 */
INSERT INTO Detail VALUES (1, 1, 2, 1);
INSERT INTO Detail VALUES (1, 1, 5, 1);
INSERT INTO Detail VALUES (3, 2, 8, 1);

INSERT INTO Detail VALUES (2, 1, 1, 2); /* Facture 2 */
INSERT INTO Detail VALUES (2, 2, 3, 2);
INSERT INTO Detail VALUES (4, 3, 4, 2);
INSERT INTO Detail VALUES (2, 0, 6, 2);

INSERT INTO Detail VALUES (3, 3, 1, 3); /* Facture 3 */
INSERT INTO Detail VALUES (2, 2, 9, 3);
INSERT INTO Detail VALUES (2, 2, 7, 3);

INSERT INTO Detail VALUES (5, 3, 2, 4); /* Facture 4*/
