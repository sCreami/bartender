...
\definecolor{mycolor}{rgb}{1, 0, 0}% Rule colour
\makeatletter
\newcommand{\mybox}[1]{%
  \setbox0=\hbox{#1}%
  \setlength{\@tempdima}{\dimexpr\wd0+13pt}%
  \begin{tcolorbox}[colframe=mycolor,boxrule=1pt,arc=4pt,
      left=6pt,right=6pt,top=6pt,bottom=6pt,boxsep=0pt,width=17cm]
    #1
  \end{tcolorbox}
}
...
\mybox{Les identifiant de connexion sont Nom: \texttt{Marcel} et Mot de passe: \texttt{hunter2}}
